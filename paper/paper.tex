...
\hypersetup{unicode=true,
            ...
            pdfauthor={Markus Konkol (m.konkol@uni-muenster.de), Daniel Nüst, Laura Goulier (Institute for Geoinformatics, University~of~Münster, Münster,~Germany)},
            pdfborder={0 0 0},
            breaklinks=true}
...
\usepackage{url} \usepackage{breakurl} \PassOptionsToPackage{hyperindex,breaklinks}{hyperref}
