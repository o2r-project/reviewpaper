...
\newcommand{\getAff}[1]{
  \getIndex{#1}{Institute for Geoinformatics}
}
...
\begin{flushleft}
{\Large
\textbf\newline{Publishing computational research - A review of infrastructures for
reproducible and transparent scholarly communication (Preprint)} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
}
\newline
% Insert author names, affiliations and corresponding author email (do not include titles, positions, or degrees).
\\
Markus Konkol\textsuperscript{\getAff{Institute for Geoinformatics}}\textsuperscript{*},
Daniel Nüst\textsuperscript{\getAff{Institute for Geoinformatics}},
Laura Goulier\textsuperscript{\getAff{Institute for Geoinformatics}}\\
\bigskip
\textbf{\getAff{Institute for Geoinformatics}}Institute for Geoinformatics, Heisenbergstr. 2, Münster, Germany, 48149\\
\bigskip
* Corresponding author: m.konkol@uni-muenster.de\\
\end{flushleft}
