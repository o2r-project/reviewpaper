...
```{r I2, include=T}
Data_interactive_2=cbind(interactive[,1], interactive[,5:8])
...
```{r I3, include=T}
Data_interactive_3=cbind(interactive[,1], interactive[,9:13])
...
```{r I4, include=T}
Data_interactive_4=cbind(interactive[,1], interactive[,14:17])
